...
import com.sample.myapplication.adapters.UserAdapter;
import com.sample.myapplication.databinding.ActivityUserBinding;
import com.sample.myapplication.listeners.UserListener;
...
// Show user available in firestore
    ...
    private void getUsers(){
        ...
        database.collection(Constants.KEY_COLLECTION_USER)
                ...
                .addOnCompleteListener(task->{
                    loading(false);
                    String currentUserId=preferneceManager.getString(Constants.KEY_USER_ID);
