...
public class SignUpActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Log.i("message",binding.getClass().toString());
    ...
    private void signUp(){
        ...
        database.collection(Constants.KEY_COLLECTION_USER)
                ...
                .addOnSuccessListener(documentReference ->{
                    ...
                    preferneceManager.putString(Constants.KEY_USER_ID, documentReference.getId());
                    preferneceManager.putString(Constants.KEY_NAME, binding.inputName.getText().toString());
                    preferneceManager.putString(Constants.KEY_IMAGE, encodedImage);
    ...
    private Boolean isValidSignUpDetails(){
        if(encodedImage == null){
            ...
            showToast("Enter same password in both fields");
            return false;
        }else{
            return true;
        }
