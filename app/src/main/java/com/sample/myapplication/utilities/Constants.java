package com.sample.myapplication.utilities;
    ...
    public static HashMap<String, String> getRemoteMsgHeader(){
        if(remoteMsgHeader == null){
            ...
            remoteMsgHeader.put(
                    ...
                    "key=AAAAh5AkQrU:APA91bFXsOnGblm2mCv86i8MKG7govSgrVLSm7mjAKSr7d0kCD93aQuB8xHO102VRQjg8Di3bcvgrcs7-WckvxHvdELybZK8_aOTU-b06rqAEu78m70gWpI__6OyO0eGu4l1vZXP9TqM"
            );
            remoteMsgHeader.put(
